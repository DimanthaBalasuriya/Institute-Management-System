...
public class ReorderPointItem extends javax.swing.JFrame {

    public ReorderPointItem() {
        initComponents();
        tablePreviewValue();
    }
    ...
    private void initComponents() {
        ...
        jPanel4.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 5, 100, 30));
        ...
        jPanel4.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 5, 50, 30));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            String path = "D://MYPROJECT//CAMBRIDGE_NEW_VERSION_1_0//src//com//prog//cnv//sys//report//ReorderPointItemList.jrxml";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReorderPointItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReorderPointItem().setVisible(true);
            }
        });
    }
    ...
    private void tablePreviewValue() {
        try {
            ResultSet rs = Database.getData("SELECT ite.ite_name, ite.ite_serial, ite.ite_type, ite.ite_unit_price, ite.ite_quantity, itc.itc_code FROM Item ite, itemCode itc WHERE ite.itc_id = itc.itc_id AND ite.ite_quantity <= '" + Systemcontroller.rop + "' AND ite.ite_quantity > '" + 0 + "' ");
